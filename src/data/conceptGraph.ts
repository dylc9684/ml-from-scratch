...
const conceptDomains: Record<string, ConceptDomain> = {
  ...
  "bayes-rule-visualizer": "probability",
  "bayesian-regression": "probability",
  "gaussian-discriminant-analysis": "probability",
  ...
  "regularization-and-noise": "optimization",
  ...
  "determinant-visualizer": "foundations",
  "find-magic-directions": "foundations",
...
export const conceptRelationships: ConceptRelationship[] = [
  ...
  { source: "logistic-regression", target: "gaussian-discriminant-analysis", label: "discriminative vs generative", kind: "alternative" },
  ...
  { source: "bayes-rule-visualizer", target: "naive-bayes", label: "posterior update", kind: "foundation" },
  { source: "bayes-rule-visualizer", target: "hidden-markov-models", label: "posterior sequence decoding", kind: "foundation" },
  { source: "bayes-rule-visualizer", target: "gaussian-discriminant-analysis", label: "likelihood to posterior", kind: "foundation" },
  { source: "bayes-rule-visualizer", target: "bayesian-regression", label: "prior to posterior", kind: "foundation" },
  { source: "bayes-rule-visualizer", target: "model-evaluation", label: "base-rate diagnostics", kind: "evaluates" },
  { source: "bayes-rule-visualizer", target: "imbalanced-data", label: "rare-event trap", kind: "depends-on" },
  ...
  { source: "gaussian-discriminant-analysis", target: "naive-bayes", label: "Gaussian likelihoods", kind: "extends" },
  { source: "gaussian-discriminant-analysis", target: "regularization-and-noise", label: "covariance shrinkage", kind: "depends-on" },
  { source: "gaussian-discriminant-analysis", target: "model-evaluation", label: "calibrated classification", kind: "evaluates" },
  ...
  { source: "polynomial-features", target: "regularization-and-noise", label: "high-degree stability", kind: "depends-on" },
  { source: "bias-variance", target: "ensemble-methods", label: "variance reduction", kind: "extends" },
  { source: "bias-variance", target: "regularization-and-noise", label: "variance control", kind: "optimizes" },
  { source: "ensemble-methods", target: "hyperparameter-tuning", label: "learner search", kind: "optimizes" },
  { source: "hyperparameter-tuning", target: "regularization-and-noise", label: "alpha search", kind: "optimizes" },
  { source: "regularization-and-noise", target: "loss-functions", label: "penalized objective", kind: "depends-on" },
  ...
  { source: "building-tokenizer", target: "hidden-markov-models", label: "token sequence tags", kind: "foundation" },
  ...
  { source: "stochastic-processes", target: "hidden-markov-models", label: "hidden Markov states", kind: "extends" },
  { source: "time-series", target: "hidden-markov-models", label: "regime switching", kind: "extends" },
  { source: "dynamic-programming", target: "hidden-markov-models", label: "Viterbi recurrence", kind: "foundation" },
  ...
  { source: "singular-value-decomposition", target: "determinant-visualizer", label: "matrix geometry", kind: "foundation" },
  { source: "singular-value-decomposition", target: "find-magic-directions", label: "spectral directions", kind: "foundation" },
  ...
  { source: "determinant-visualizer", target: "convex-optimization", label: "Jacobian geometry", kind: "foundation" },
  { source: "determinant-visualizer", target: "neural-network", label: "linear transforms", kind: "foundation" },
  { source: "determinant-visualizer", target: "polynomial-features", label: "feature-space maps", kind: "foundation" },
  { source: "determinant-visualizer", target: "find-magic-directions", label: "eigenvalue product", kind: "extends" },
  { source: "find-magic-directions", target: "convex-optimization", label: "curvature axes", kind: "foundation" },
  { source: "find-magic-directions", target: "neural-network", label: "weight matrix behavior", kind: "foundation" },
